...
There are many examples of gender bias in NLP as research has shown\cite{gender-bias-nlp}. % TODO Find out training data, if not possible should be mentioned
...
\subsection{Context}
% TODO reflect on even broader settings of the app
% What kind of data is collected and is it used for advertising?
% What kind of possible ethical / value questions might emerge?
% Who are further stakeholders of the app - people or organizations that might benefit or be harmed by it?
% Paid / free app?
